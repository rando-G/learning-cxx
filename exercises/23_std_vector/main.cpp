...
int main(int argc, char **argv) {
    ...
    }
    {
        ...
        }
        {
            ...
            // ASSERT(vec[48] == 'a', "Fill in the correct value.");
            // ASSERT(vec[49] == 'b', "Fill in the correct value.");
            // ASSERT(vec[50] == 'c', "Fill in the correct value.");
            // ASSERT(vec[51] == 'd', "Fill in the correct value.");
        }
    }
